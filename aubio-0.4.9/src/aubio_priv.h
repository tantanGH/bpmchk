...
/* Memory management */
#ifdef XDEV68K
#define AUBIO_MALLOC(_n)             ((void*)MALLOC(_n))
#define AUBIO_REALLOC(_p,_n)         ((void*)SETBLOCK((int)_p,_n))
...
#define AUBIO_FREE(_p)               MFREE((int)_p)
#else
...
#if !defined(_MSC_VER)
#ifdef XDEV68K
#define AUBIO_STRERROR(errno,buf,len) sprintf(buf,"errno=%d",errno)
#else
